...
//     const fetchData = async () => {
//         try {
//           const response = await axios.get(`http://103.175.171.149:8080/api/students?kishoriVarg=${kishoriVarg}`);
...
//         navigation.navigate('UpdateChildDetails', { name: childFullName });
//       };

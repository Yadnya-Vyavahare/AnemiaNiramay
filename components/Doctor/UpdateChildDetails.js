...
const CreateChildDetails = ({ navigation }) => {
    ...
    const onSystemicExaminationPressed = () => {
        navigation.navigate('SystemicExamination', { childFullName: childFullName });
    }
    ...
    const onPhysicalExaminationPressed = () => {
        navigation.navigate('PhysicalExamination', { childFullName: childFullName });
    }
    ...
    const onDetailPhysicalExaminationPressed = () => {
        navigation.navigate('DetailPhysicalExamination', { childFullName: childFullName });
    }
    ...
    const onRemarksPressed = () => {
        navigation.navigate('Remarks', { childFullName: childFullName });
    }

...
const DisplayListChildCreate = ({ navigation }) => {
    ...
    const handlePress = (item) => {
        ...
        navigation.navigate('CreateChildDetails', { childFullName: childFullName,kishoriVarg:kishoriVarg });
      };
...
export default DisplayListChildCreate;